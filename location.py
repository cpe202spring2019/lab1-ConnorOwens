...
# 4. both loc1 and loc4 have the same printed message
...
class Location:
    ...
    # 9. the results are different now because the eq method always returns true if the components are equal
